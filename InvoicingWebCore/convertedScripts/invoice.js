...
function AddItem() {
    ...
    $.each(JSON.parse(quantityUnits), function (i, item) {
        $('#quantityUnit_' + rowId).append($('<option>', {
            value: item,
            text: item
        }));
    });
